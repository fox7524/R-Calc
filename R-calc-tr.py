...
class ResistorCalculator(QWidget):
    ...
    def refresh_band_setup(self):
        ...
        if current_os == 'Darwin':  # macOS
            ...
            band_geometry_map = {
                4: [(125, 15, 15, 79), (167, 15, 15, 79), (209, 15, 15, 79), (299, 10, 15, 92)],
                5: [(75, 16, 15, 81), (131, 22, 15, 67), (168, 22, 15, 67), (205, 22, 15, 67), (284, 16, 15, 81)],
                6: [(60, 10, 16, 89), (122, 16, 15, 75), (145, 16, 15, 75), (168, 16, 15, 75), (230, 16, 15, 75), (286, 10, 16, 89)]
            }
        else:  # Windows
            band_geometry_map = {
