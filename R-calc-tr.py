...
class ResistorCalculator(QWidget):
    ...
    def refresh_band_setup(self):
        ...
        if current_os == 'Darwin':  # macOS
            ...
            band_geometry_map = {
                4: [(120, 18, 14, 75), (167, 18, 14, 75), (209, 18, 14, 75), (299, 12, 14, 88)],
                5: [(68, 19, 14, 77), (124, 25, 14, 63), (161, 25, 14, 63), (198, 25, 14, 63), (277, 19, 14, 77)],
                6: [(53, 13, 15, 85), (115, 19, 14, 71), (138, 19, 14, 71), (161, 19, 14, 71), (223, 19, 14, 71), (279, 13, 15, 85)]
            }
        else:  # Windows
            band_geometry_map = {
